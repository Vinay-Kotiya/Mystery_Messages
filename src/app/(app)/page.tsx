...
const Home = () => {
  ...
  // const [dotGridLoaded, setDotGridLoaded] = useState(false);

  // Simulate DotGrid mount completion (if DotGrid has onLoad or similar use that)
  // useEffect(() => {
  //   const timer = setTimeout(() => {
  //     setDotGridLoaded(true);
  //   }, 1000); // simulate 1s load time (adjust as needed)
  ...
  return (
    <>
      <main className="relative flex justify-center items-center w-full flex-col px-4 md:px-24 py-12 min-h-screen overflow-hidden">
        {/* DotGrid or Loader */}
        {/* {!dotGridLoaded ? (
        ...
        <div className="relative z-10 backdrop-blur p-3 rounded-2xl">
